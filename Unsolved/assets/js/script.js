...
const allH4Elements = document.querySelector('h4')
allH4Elements.fotEach(element => {
    element.setAttribute('style', 'color:blue; font-weight: bold; font-seize: 30px; padding-left: 10px; margin: 0px')
})